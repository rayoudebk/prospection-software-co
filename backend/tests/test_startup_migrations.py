...
def test_run_startup_migrations_uses_sync_database_url(monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        lambda *, database_url: calls.append(("sourcing_brief", database_url)),
    )
    monkeypatch.setattr(
        startup_migrations,
    ...
    monkeypatch.setattr(
        ...
        lambda *, database_url: calls.append(("expansion_generation", database_url)),
    )
    monkeypatch.setattr(
        startup_migrations,
    ...
    assert calls == [
        ...
        ("sourcing_brief", "postgresql://example/test"),
        ("expansion_brief", "postgresql://example/test"),
        ("expansion_generation", "postgresql://example/test"),
