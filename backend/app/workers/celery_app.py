...
celery_app.conf.update(
    ...
    task_routes={
        ...
        "app.workers.workspace_tasks.refresh_company_context_pack": {"queue": "discovery.crawl"},
        ...
        "app.workers.workspace_tasks.run_claims_graph_refresh": {"queue": "discovery.score"},
        "app.workers.workspace_tasks.generate_static_report": {"queue": "discovery.score"},
